...
router.register(r'articles', ArticleViewSet, basename='article')  # No trailing slash here
router.register(r'authors', AuthorViewSet, basename='author')  # No trailing slash here
...
urlpatterns = [
    ...
    *redirects_urlpatterns,
    ...
    # Custom URL for retrieving articles by slug or UUID (trailing slash optional)
    ...
    # Custom URL for retrieving articles by category (trailing slash optional)
    ...
    # Custom URL for retrieving articles by primary category (trailing slash optional)
    ...
    # Custom URL for retrieving all categories (trailing slash optional)
